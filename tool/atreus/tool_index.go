...
var toolIndexs = []*Tool{
	&Tool{
		...
		Install:   "go get -u github.com/mapgoo-lab/atreus/tool/atreus",
		Summary:   "Kratos工具集本体",
	...
	&Tool{
		...
		Alias:     "atreus-protoc",
		BuildTime: time.Date(2019, 6, 21, 0, 0, 0, 0, time.Local),
		Install:   "go get -u github.com/mapgoo-lab/atreus/tool/atreus-protoc",
	...
	&Tool{
		...
		Install:   "go get -u github.com/mapgoo-lab/atreus/tool/atreus-gen-bts",
		Summary:   "缓存回源逻辑代码生成器",
		Platform:  []string{"darwin", "linux", "windows"},
		Author:    "atreus",
	},
	&Tool{
		...
		Alias:     "atreus-gen-mc",
		BuildTime: time.Date(2019, 7, 23, 0, 0, 0, 0, time.Local),
		Install:   "go get -u github.com/mapgoo-lab/atreus/tool/atreus-gen-mc",
		Summary:   "mc缓存代码生成",
		Platform:  []string{"darwin", "linux", "windows"},
		Author:    "atreus",
	},
