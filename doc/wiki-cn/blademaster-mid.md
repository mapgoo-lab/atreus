...
先来看一段鉴权伪代码示例([auth示例代码位置](https://github.com/mapgoo-lab/atreus/tree/master/example/blademaster/middleware/auth))：
...
更多关于自适应限流的信息可参考：[atreus 自适应限流](/doc/wiki-cn/ratelimit.md)。如要使用如下：
